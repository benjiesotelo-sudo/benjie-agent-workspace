...
- [docs/mission-control.md](docs/mission-control.md) - what Mission Control's nine views and the Bridge page show, how to move around them, and how to start or stop them, with pictures.
