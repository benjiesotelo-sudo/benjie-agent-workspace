...
READY = ("office", "tasks", "approvals", "projects", "system")
...
def system_cards(r, crew, model, now, records_ok=True, agents_ok=True):
    ...
    if "bridge" not in r:
        ...
        if mcr is None:
            ...
            card("Mission Control", "green" if mcr else "red",
                 "Mission Control: running in its Herdr space" if mcr else "Mission Control: not running",
                 (), "Mission Control")
