...
# task board and a week calendar, in one terminal pane; bin/fm_mission_control.py owns what it
...
#                           <v> is office, tasks, calendar, or a later
#                           view's name
#
...
# its pane (`herdr agent focus`, navigation only). On the calendar, left and
# right move a week and t returns to this week. Tapping a tab switches view
