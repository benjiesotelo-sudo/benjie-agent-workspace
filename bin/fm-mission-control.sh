...
# the health of the machine and the crew's plumbing, in one terminal pane; bin/fm_mission_control.py owns what it reads, how the
...
#                           <v> is office, tasks, approvals, projects, system,
#                           or a later view's name. --readings is a saved set
#                           of System readings; without it the system view
#                           reads this machine and Herdr once, and the other
#                           views leave the system unchecked
#
