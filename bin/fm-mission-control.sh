...
# calendar, the crew as an org chart and the health of the machine and the
# crew's plumbing, in one terminal pane; bin/fm_mission_control.py owns what
# it reads, how the crew maps onto the office, and how frames are drawn. It is
