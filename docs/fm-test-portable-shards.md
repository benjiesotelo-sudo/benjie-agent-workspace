...
| portable serial 1-4 | job `timeout-minutes: 30` | Shards measure up to about 19 minutes on a busy runner, so the cap is a hang tripwire with margin above that. |
